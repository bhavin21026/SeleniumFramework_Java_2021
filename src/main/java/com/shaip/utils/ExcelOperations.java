...
public class ExcelOperations {
	...
	public ExcelOperations(String sheetName, String Portal) {
		try {

			if (Portal.equalsIgnoreCase("EP")) {
				filePath = System.getProperty("user.dir")
						+ PropertiesOperationsShaip.getPropertyValueByKey("testDataLocationEP");
			} else if (Portal.equalsIgnoreCase("CP")) {
				filePath = System.getProperty("user.dir")
						+ PropertiesOperationsShaip.getPropertyValueByKey("testDataLocationCP");
