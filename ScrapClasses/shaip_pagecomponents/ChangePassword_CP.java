...
public class ChangePassword_CP extends TestBaseShaip {
	...
	public ChangePassword_CP verifyPasswordUpdateSuccessToaster() throws InterruptedException {
		...
		if (wait.until(ExpectedConditions.visibilityOf(toaster_Message)) != null) {
			...
			assert_custom(toasterMessages, "The password has been updated successfully",
	...
	public ChangePassword_CP verifyPasswordIncorrectErrorToaster() throws InterruptedException {
		...
		if (wait.until(ExpectedConditions.visibilityOf(toaster_Message)) != null) {
			sa.assertTrue(toaster_Message.isDisplayed(), "Toaster message is not getting displayed");
			String toasterMessages = getText_custom(toaster_Message, "Toaster Message");
			assert_custom(toasterMessages, "The Old Password is incorrect", "Toaster message getting displayed");
			Thread.sleep(1000);
			click_custom(btn_closeToaster, "Close Toaster");
			Thread.sleep(1000);
			sa.assertAll();
